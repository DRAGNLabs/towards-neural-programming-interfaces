...
python3 train_neural_program_interfaces.py --save_file_path ~/Documents/npi_train_test1_02012020/ --train_file_path_base ~/Documents/random_data_02012020.pkl --style_coeff 1.5 --similarity_coeff 2.05 --npi_type 'ConvNPI' --classifier_type adversarial --num_epochs 50 --batch_size 2 --test_freq 2 --save_freq 3
